...
class PaymentTransactionService
{
    ...
    private function generateReceiveTransaction($order)
    {
        ...
        $shopowner_balance_id = !blank($shop) ? $shop->user->balance_id : 0;
        ...
        $this->addTransaction(TransactionType::TRANSFER, $this->owner_id, $shopowner_balance_id, $paymentAmount, $meta);
