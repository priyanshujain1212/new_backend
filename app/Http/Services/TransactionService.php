...
class TransactionService
{
    ...
    protected function transaction( int $type = 0, int $sourceBalanceId = 0, int $destinationBalanceId = 0, int $paymentMethod = 0, $amount = 0, $orderId = 0 )
    {
        $transaction = [
            'type'                   => $type,
    ...
    public function addFund( int $sourceBalanceId = 0, int $destinationBalanceId = 0, int $paymentMethod = 0, $amount = 0, $orderId = 0 ) //done
    {
        return $this->transaction(TransactionType::ADDFUND, $sourceBalanceId, $destinationBalanceId, $paymentMethod, $amount, $orderId);
    }

    public function payment( int $sourceBalanceId = 0, int $destinationBalanceId = 0, $amount = 0, $orderId = 0 ) //done
    {
        return $this->transaction(TransactionType::PAYMENT, $sourceBalanceId, $destinationBalanceId, 0, $amount, $orderId);
    }

    public function refund( int $sourceBalanceId = 0, int $destinationBalanceId = 0, $amount = 0, $orderId = 0 )
    {
        return $this->transaction(TransactionType::REFUND, $sourceBalanceId, $destinationBalanceId, 0, $amount, $orderId);
    }

    public function transfer( int $sourceBalanceId = 0, int $destinationBalanceId = 0, $amount = 0, $orderId = 0 ) //done
    {
        return $this->transaction(TransactionType::TRANSFER, $sourceBalanceId, $destinationBalanceId, 0, $amount, $orderId);
    }

    public function withdraw(int $sourceBalanceId = 0, int $destinationBalanceId = 0, $amount = 0) //done
    {
    ...
    public function cashBack( int $sourceBalanceId = 0, int $destinationBalanceId = 0, $amount = 0, $addFund = true) //done
    {
        if($addFund) {
    ...
    public function deposit( int $sourceBalanceId = 0, int $destinationBalanceId = 0, $amount = 0) //done
    {
