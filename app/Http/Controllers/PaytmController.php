...
class PaytmController extends Controller
{
	...
	public function handlePaytmRequest($cart_id, $amount ) 
    {
		...
		$paramList["MID"] = 'MrECHO44772381378639';
		$paramList["ORDER_ID"] = '5';
		$paramList["CUST_ID"] = '2';
		$paramList["INDUSTRY_TYPE_ID"] = 'Retail';
		$paramList["CHANNEL_ID"] = 'WEB';
		$paramList["TXN_AMOUNT"] = $amount;
		$paramList["WEBSITE"] = 'WEBSTAGING';
		$paramList["CALLBACK_URL"] = url( 'https://mrecho.in/paytm-callback' );
		$paytm_merchant_key = 'LXtNiLMmgrDHpK_k';
