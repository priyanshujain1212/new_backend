...
class NotificationOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $orders = Order::where(['delivery_boy_id' => null])->whereIn('status', [OrderStatus::ACCEPT, OrderStatus::PROCESS])->latest()->whereNotIn('id', $deliveryStatusHistoriesArray)->get();
    ...
    {
        $order = Order::where(['id' => $id])->latest()->with('items', 'items.product', 'items.variation', 'invoice.transactions')->first();
