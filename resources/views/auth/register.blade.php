                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label  class="custom-control custom-checkbox">
                                ...
                                <span class="custom-control-label" id="terms_and_condition_color"> {{ __('I am agree with') }}</span> <a target="_blank" href="{{ route('page', 'terms-and-condition') }}">{{ __('terms and conditions') }}</a> <span class="text-danger">*</span>
