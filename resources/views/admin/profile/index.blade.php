                    ...
                    <div class="card profile-widget">
                        ...
                        <div class="profile-widget-description">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-sm-4">{{ __('Limit') }}</dt>
                                <dd class="col-sm-8">{{ isset($user->deposit->limit_amount) ? currencyFormat($user->deposit->limit_amount) : '' }}</dd>
                                <dt class="col-sm-4">{{ __('Deposit') }}</dt>
                                <dd class="col-sm-8">{{ isset($user->deposit->deposit_amount) ? currencyFormat($user->deposit->deposit_amount) : '' }}</dd>
                                ...
                                @if(auth()->user()->myrole == \App\Enums\UserRole::DELIVERYBOY)
                                    ...
                                    <dd class="col-sm-8">{{ currencyFormat($user->deliveryBoyAccount->balance > 0 ? $user->deliveryBoyAccount->balance : 0 ) }}</p></dd>
                                @endif
                            </dl>
                        </div>
                    </div>
