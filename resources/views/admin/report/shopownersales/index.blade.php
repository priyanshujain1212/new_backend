...
@section('main-content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>{{ __('Shop Owner Sales Report') }}</h1>
            {{ Breadcrumbs::render('shop-owner-sales-report') }}
        </div>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?=route('admin.shop-owner-sales-report.index')?>" method="POST">
                        @csrf
                        <div class="row">

                            @if(auth()->user()->myrole == 3)

                                <input type="hidden" name="shop_id" class="form-control" value="{{ auth()->user()->shop->id ?? 0 }}">
...
@section('scripts')
    ...
    <script src="{{ asset('js/shopownersales/index.js') }}"></script>
@endsection
