                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="status" name="status" class="form-control @error('status') is-invalid @enderror">
                                                            <option value="0">{{ __('Select Order Status') }}</option>
                                    ...
                                    @if($showReceive)
                                        <div class="section-title">{{ __('Change Product Receive') }}</div>
                                        <div class="order card">
                                            <form action="{{ route('admin.orders.product-receive', $order) }}" method="POST">
                                                @csrf
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label for="product_received">{{ __('Product Received') }}</label> <span class="text-danger">*</span>
                                                        <select id="product_received" name="product_received" class="form-control @error('product_received') is-invalid @enderror">
                                                            <option value="10">{{ __('Not Receive') }}</option>
                                                            <option value="5">{{ __('Receive') }}</option>
                                                        </select>
