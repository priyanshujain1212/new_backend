...
<section class="section">
    ...
    <div class="section-body">
        <form action="{{ route('admin.shop.shopupdate', $shop->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="form-group col">
                                    ...
                                    <select name="location_id" id="location"
                                        ...
                                        <option value="{{ $location->id }}"
                                            {{ (old('location_id', $shop->location_id) == $location->id) ? 'selected' : '' }}>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select name="area_id" id="area"
                                        ...
                                        <option value="{{ $area->id }}"
                                            {{ (old('area_id', $shop->area_id) == $area->id) ? 'selected' : '' }}>{{ $area->name }}
                                        </option>
                                        @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="delivery_charge"
                                        ...
                                        value="{{ old('delivery_charge', $shop->delivery_charge) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="shopaddress"
                                    ...
                                    id="shopaddress">{{ old('shopaddress', $shop->address) }}</textarea>
                                @error('shopaddress')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input id="opening_time" type="text" name="opening_time"
                                        ...
                                        value="{{ old('opening_time', $shop->opening_time) }}">
                                    @error('opening_time')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group col">
                                    ...
                                    <input id="closing_time" type="text" name="closing_time"
                                        ...
                                        value="{{ old('closing_time', $shop->closing_time) }}">
                                    @error('closing_time')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
