                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.shop.products.update', [$shop, $shopproduct]) }}" method="POST">
                        ...
                        <div class="row" id="single-product">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="unit_price" name="unit_price"
                                        ...
                                        value="{{ old('unit_price', $shopproduct->unit_price) }}" step="any">
                                    @error('unit_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="discount_price">{{ __('Discount Price') }}</label> <span
                                        class="text-danger">*</span>
                                    <input type="number" id="discount_price" name="discount_price"
                                           class="form-control @error('discount_price') is-invalid @enderror"
                                           value="{{ old('discount_price', $shopproduct->discount_price) }}" step="any">
                                            ...
                                            @elseif(!blank($product_variations))
                                                @foreach($product_variations as $product_variation)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="variation[<?=$variation?>][price]" placeholder="Price" class="form-control form-control-sm change-productprice @error("variation.$variation.price") is-invalid @enderror" value="{{ old("variation.$variation.price", $product_variation->price) }}" step="any">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="number" name="variation[<?=$variation?>][discount_price]" placeholder="Discount Price" class="form-control form-control-sm change-productdiscountprice @error("variation.$variation.discount_price") is-invalid @enderror" value="{{ old("variation.$variation.discount_price",$product_variation->discount_price) }}" step="any">
                                                        </td>
                                                        <td>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                             ...
                                             @elseif(!blank($product_options))
                                                ...
                                                @foreach($product_options as $product_option)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="option[<?=$option?>][price]" placeholder="Price" class="form-control form-control-sm change-productprice @error("option.$option.price") is-invalid @enderror" value="{{ old("option.$option.price", $product_option->price) }}" step="any">
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-danger btn-sm removeBtn">
                                                                <i class="fa fa-trash"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="option[1][price]" placeholder="Price" class="form-control form-control-sm change-productprice @error("option.1.price") is-invalid @enderror" value="{{ old('option.1.price', $productPrice) }}" step="any">
                                                </td>
                                                <td>
