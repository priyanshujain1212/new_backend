                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select name="area_id" id="area" class="select2 form-control @error('area_id') is-invalid red-border @enderror">
                                    ...
                                    <select name="section_id" id="section" class="select2 form-control form-control-sm @error('section_id') is-invalid red-border @enderror" data-url="{{ route('admin.section.get-section') }}">
                                        ...
                                        @if(!blank($sections))
                                            @foreach($sections as $section)
                                                <option value="{{ $section->id }}" {{ (old('section_id', $shop->section_id) == $section->id) ? 'selected' : '' }}>{{ $section->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('section_id')
