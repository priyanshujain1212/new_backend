            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.homepage-update') }}">
                     ...
                     <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Step One') }}</legend>
                         <div class="row">
                             <div class="col-sm-3">
                                 <div class="form-group">
                                     <label for="step_one_icon">{{ __('Icon') }}</label>
                             ...
                             <div class="col-sm-3">
                                 <div class="form-group">
                                     <label for="step_one_title">{{ __('Title') }}</label>
                                     <span class="text-danger">*</span>
                             ...
                             <div class="col-sm-6">
                                 <div class="form-group">
                                     <label for="step_one_description">{{ __('Description') }}</label>
                                     <span class="text-danger">*</span>
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Step Two') }}</legend>
                         <div class="row">
                             <div class="col-sm-3">
                                 <div class="form-group">
                                     <label for="step_two_icon">{{ __('Icon') }}</label>
                                     <span class="text-danger">*</span>
                             ...
                             <div class="col-sm-3">
                                 <div class="form-group">
                                     <label for="step_two_title">{{ __('Title') }}</label>
                                     <span class="text-danger">*</span>
                             ...
                             <div class="col-sm-6">
                                 <div class="form-group">
                                     <label for="step_two_description">{{ __('Description') }}</label>
                                     <span class="text-danger">*</span>
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Step Three') }}</legend>
                         <div class="row">
                             <div class="col-sm-3">
                                 <div class="form-group">
                                     <label for="step_three_icon">{{ __('Icon') }}</label>
                                     <span class="text-danger">*</span>
                             ...
                             <div class="col-sm-3">
                                 <div class="form-group">
                                     <label for="step_three_title">{{ __('Title') }}</label>
                                     <span class="text-danger">*</span>
                             ...
                             <div class="col-sm-6">
                                 <div class="form-group">
                                     <label for="step_three_description">{{ __('Description') }}</label>
                                     <span class="text-danger">*</span>
                     ...
                     <div class="row">
                         <div class="form-group col-md-6">
                            <button type="submit" class="btn btn-primary">
                                <span>{{ __('Update Step Setting') }}</span>
                            </button>
                         </div>
                     </div>
                </form>
