                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-sm-6 offset-sm-3">
                                    <div class="input-group input-daterange" id="date-picker">
                                        <select class="form-control" id="status" name="status" id="">
                                            @foreach(trans('rating_statuses') as $key => $status)
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="maintable" data-url="{{ route('admin.rating.get-rating') }}" data-status="{{ \App\Enums\RatingStatus::ACTIVE }}" data-hidecolumn="{{ auth()->user()->can('rating') }}">
                                    <thead>
                                    <tr>
                                        <th>{{ __('levels.id') }}</th>
                                        <th>{{ __('levels.image') }}</th>
                                        <th>{{ __('levels.product_name') }}</th>
                                        <th>{{ __('levels.shop_name') }}</th>
                                        <th>{{ __('levels.rating') }}</th>
                                        <th>{{ __('levels.review') }}</th>
