                    ...
                    <div class="card">
                        @can('location_create')
                            <div class="card-header">
                                <a href="{{ route('admin.location.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> {{ __('Add Location') }}
                                </a>
                            </div>
                        @endcan
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="maintable" data-url="{{ route('admin.location.get-location') }}" data-status="{{ \App\Enums\Status::ACTIVE }}" data-hidecolumn="{{ auth()->user()->can('location_edit') || auth()->user()->can('location_delete') }}">
                                    <thead>
                                    <tr>
                                        <th>{{ __('levels.id') }}</th>
