                ...
                <div class="card">
                    ...
                    @can('request-products_create')
                        <div class="card-header">
                            <a href="{{ route('admin.request-products.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> {{ __('Add Request Product') }}</a>
                        </div>
                    @endcan
