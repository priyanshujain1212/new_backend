...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        Dropzone.options.documentDropzone = {
            url: '{{ route('admin.request-products.updateMedia', $product) }}',
            maxFilesize: 2, // MB
            maxFiles:5,
            ...
            removedfile: function (file) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.request-products.removeMedia') }}',
            ...
            init: function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.request-products.getMedia') }}',
